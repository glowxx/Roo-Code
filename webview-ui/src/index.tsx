		...
		rootEl.innerHTML = `
			<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;width:100%;background-color:#090a0f;color:#f2f4f7;font-family:-apple-system,sans-serif;padding:24px;box-sizing:border-box;text-align:center;">
				<div style="max-width:480px;background:#12141c;border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:28px 24px;box-shadow:0 8px 32px rgba(0,0,0,0.5);">
					...
					<h2 style="font-size:16px;margin:0 0 8px 0;font-weight:600;">Wystąpił błąd podczas inicjalizacji widoku</h2>
					<p style="font-size:13px;color:#98a2b3;margin:0 0 16px 0;line-height:1.4;">Nie udało się uruchomić aplikacji. Kliknij poniżej, aby przeładować stronę.</p>
					<button onclick="window.location.reload()" style="padding:8px 18px;background:#2563eb;color:#fff;border:none;border-radius:8px;font-size:13px;font-weight:600;cursor:pointer;">Przeładuj widok</button>
				</div>
			</div>
		`
	}
